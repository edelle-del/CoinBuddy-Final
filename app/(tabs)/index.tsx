...
const convertToDate = (dateValue: any): Date => {
  ...
  try {
    ...
    const userName = user?.name || "User"; // Get user name with fallback
    ...
    let htmlContent = `
      ...
      <body>
        <div class="header">
          ...
          <p class="generated-by">Generated by ${userName}</p>
        </div>
    ...
    // Include user name in filename for better organization
    const fileName = `CoinBuddy_Transactions_${userName}_${currentDate.toISOString().split('T')[0]}.pdf`;
